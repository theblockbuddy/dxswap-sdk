...
export class Token extends Currency {
  ...
  public static readonly WSPENT: { [key: number]: Token; } = {
    [ChainId.ESPENTO]: new Token(ChainId.ESPENTO, '0x32c854b1cb64E135E14a140016674Aec4c38f41d', 18, 'WSPENT', 'Wrapped WSPENT')
  };
  ...
  private static readonly NATIVE_CURRENCY_WRAPPER: { [chainId in ChainId]: Token } = {
    ...
    [ChainId.ESPENTO]: Token.WSPENT[ChainId.ESPENTO]
  };
...
export const WSPENT = Token.WSPENT;
